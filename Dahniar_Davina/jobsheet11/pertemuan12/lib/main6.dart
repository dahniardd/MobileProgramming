...
// =======================================================================
// SERVICE: NoteService – simpan setiap note ke file JSON terpisah
// =======================================================================
...
class NoteService {
  ...
  Future<void> saveNote({
    ...
    final Directory notesDir =
        await _dirService.createDirectory(_notesDir);
  ...
  Future<List<Map<String, dynamic>>> getAllNotes() async {
    ...
    // sort latest first
    notes.sort(
      (a, b) => b['created_at'].toString().compareTo(a['created_at']),
    );
...
// =======================================================================
// NotesPage – tampilkan list catatan
// =======================================================================
...
// =======================================================================
// AddNotePage – form untuk menulis note baru
// =======================================================================
...
// =======================================================================
// NoteDetailPage – tampilkan isi note
// =======================================================================
